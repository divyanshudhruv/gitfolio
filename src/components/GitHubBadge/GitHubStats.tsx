  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-2" style={{ marginBottom: "20px" }}>
        <StatBadge
          icon={<Users2 className="w-3 h-5 mr-1" />}
          value={followers}
          label="Followers"
        />
        <StatBadge
          icon={<Star className="w-3 h-5 mr-1" />}
          value={stars}
          label="Stars"
        />
        <StatBadge
          icon={<GitFork className="w-3 h-5 mr-1" />}
          value={forks}
          label="Forks"
        />
      ...
      <div
        className="flex items-center justify-between bg-[#21262d] text-white rounded-md p-3"
